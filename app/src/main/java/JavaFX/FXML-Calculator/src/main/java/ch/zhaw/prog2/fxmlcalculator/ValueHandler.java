 ...
 * Offers the {@link #resultBound} StringProperty to listen from a GUI (bind to a field in the GUI or add listener)
 * @author bles
 * @version 1.1
 */
public class ValueHandler {
	...
	/**
	 * If the values checked by {@link #checkValues(String, String, String, String)} are ok, the return is true
	 * @return	true, if ok
	 */
